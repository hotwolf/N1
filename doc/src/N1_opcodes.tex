  ...
  \makebox[\textwidth][c]{
    \scalebox{0.475} {
      \begin{tikzpicture}
        ...
        %Return bit
        \draw [thick, fill=gray!15] (0.8,0.3) rectangle (2,36.2);
        \node [above] at (1.4,36.2) {
        ...
        \draw [thick] (21.5,35.5) -- (22.5,35.5) -- (22.5,24.5) -- (21.5,24.5);
        \node [right] at (23,29.5) {
        ...
        \begin{scope}[shift={(1,24.5)}]
          ...
          \node         at (1.5,0.5)     {\huge{\texttt{0}}};
          \node         at (2.5,0.5)     {\huge{\texttt{1}}};
          \node         at (9.5,0.45)    {\LARGE{13-bit relative address $<$ 0x1FFF}};
          \node [right] at (16.2,0.5) {
            \begin{minipage}[l]{14em}
              \large{
                Conditional branch \\
        ...
        \begin{scope}[shift={(1,2.5)}]
          ...
          \node         at (7.5,0.5)     {\huge{\texttt{1}}};
          \node         at (12,0.45)     {\LARGE{Control bits}};
          \node [right] at (16.2,0.5) {
           \begin{minipage}[l]{14em}
              \large{
                Control instruction \\
        ...
        \draw [thick] (21.5,1.5) -- (22.5,1.5) -- (22.5,0.5) -- (21.5,0.5);
        \node [right] at (23,0.5) {
          \begin{minipage}[l]{12em}
            \Huge{
              Complex \\
...
control bits is shown in \tabref{opcodes:ctrl:bits}. Multiple control bits can be set within one instruction.
...
\label{opcodes:complex}

Complex instructions trigger an internal sequence of actions. Their execution time spans multiple 
clock cycles. \tabref{opcodes:complex:instr} lists the available instructions of this category.
...
\begin{center}
  ...
  \begin{longtable}{|c|c|c|c|}
    \rowcolor{white}
    \caption{Complex instruction encoding}
    \label{opcodes:complex:instr} \\
    %Header
    \hline                                     
    \rowcolor{gray!25}
    \multicolumn{1}{|c|}{\textbf{\rule{0pt}{2.5ex}Encoding}}     &  
