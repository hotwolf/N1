...
module N1_fc
  #(parameter   TC_PSUF   = 12,                                                                //width of a stack pointer
   ...
   (//Clock and reset									       
    ...
    output reg                       fc2ir_force_rdpsh_o,                                      //load FETCH instruction (push to TOS)
    output reg                       fc2ir_force_rdrpl_o,                                      //load FETCH instruction (replace TOS)
    output reg                       fc2ir_force_ivec_o,                                        //load IVEC instruction (replace TOS)
    ...
    input  wire                      ir2fc_mem_dir_i,                                          //direct memory address
   ...
   always @*										       
     begin										       
        ...
        fc2ir_force_ivec_o       = 1'b0;                                                        //load IVEC instruction (replace TOS)
        ...
        case (state_reg)								       
                              ...
                              if (ir2fc_mem_i)
                                begin
                                   ...
                                   fc2ir_force_drop_o   = fc2ir_force_drop_o |                 //make use of onehot encoding
                                                          ~ir2fc_mem_rd_i;                     //force DROP opcode
                                   fc2ir_force_rdpsh_o  = fc2ir_force_rdpsh_o |                //make use of onehot encoding
                                                          (ir2fc_mem_rd_i & ~ir2fc_mem_dir_i); //force FETCH opcode
                                   fc2ir_force_rdrpl_o  = fc2ir_force_rdrpl_o |                //make use of onehot encoding
                                                          (ir2fc_mem_rd_i & ir2fc_mem_dir_i);  //force FETCH opcode
          ...
          STATE_UNREACH:
            begin
               ...
               fc2ir_force_call_o   =  excpt2fc_irq_i;                                         //force CALL execution
               fc2ir_force_drop_o   = ~excpt2fc_irq_i;                                         //force DROP execution
