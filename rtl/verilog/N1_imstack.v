...
module N1_imstack
  #(parameter WIDTH     = 16,  //cell width
    parameter DEPTH     =  8,  //depth of the intermediate stack
    parameter ADR_WIDTH =  8,  //address width of the lower stack (determines the depth)
    parameter DIR       =  0)  //0=lower stack grows towards lower addresses
