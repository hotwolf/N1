...
//  output wire [1:0]                        prb_us_state_o);        //FSM state
   ...
   wire                                     ir2prs_ivec2ps0;         //interrupt vector -> PS0
   ...
   wire                                     sagu2excpt_psuf;      //PS underflow
   wire                                     sagu2excpt_rsof;      //RS overflow
   wire                                     sagu2excpt_rsuf;      //RS underflow
   ...
   (//Clock and reset
    ...
    .sagu2excpt_psuf_i          (sagu2excpt_psuf),               //PS underflow
    .sagu2excpt_rsof_i          (sagu2excpt_rsof),               //RS overflow
    .sagu2excpt_rsuf_i          (sagu2excpt_rsuf),               //RS underflow
   ...
   ir
     (//Clock and reset
      ...
      .ir2prs_ivec2ps0_o        (ir2prs_ivec2ps0),               //interrupt vector -> PS0
   ...
   sagu
     (//Clock and reset
      ...
      //DSP interface
      .sagu2dsp_ps_hold_o       (sagu2dsp_ps_hold),              //maintain PSP
      .sagu2dsp_ps_adr_sel_o    (sagu2dsp_ps_adr_sel),           //1:absolute COF, 0:relative COF
      .sagu2dsp_ps_radr_o       (sagu2dsp_ps_radr),              //relative address
      .sagu2dsp_ps_aadr_o       (sagu2dsp_ps_aadr),              //absolute address
      .sagu2dsp_rs_hold_o       (sagu2dsp_rs_hold),              //maintain PSP
      .sagu2dsp_rs_adr_sel_o    (sagu2dsp_rs_adr_sel),           //1:absolute COF, 0:relative COF
      .sagu2dsp_rs_radr_o       (sagu2dsp_rs_radr),              //relative address
      .sagu2dsp_rs_aadr_o       (sagu2dsp_rs_aadr),              //absolute address

      //EXCPT interface
      .sagu2excpt_psof_o        (sagu2excpt_psof),               //PS overflow
      .sagu2excpt_psuf_o        (sagu2excpt_psuf),               //PS underflow
      .sagu2excpt_rsof_o        (sagu2excpt_rsof),               //RS overflow
      .sagu2excpt_rsuf_o        (sagu2excpt_rsuf),               //RS underflow

      //PRS interface
      .prs2sagu_hold_i          (prs2sagu_hold),                 //maintain stack pointer
      .prs2sagu_ps_rst_i        (prs2sagu_ps_rst),               //reset parameter stack
      .prs2sagu_rs_rst_i        (prs2sagu_rs_rst),               //reset return stack
      .prs2sagu_stack_sel_i     (prs2sagu_stack_sel),            //1:RS, 0:PS
      .prs2sagu_psh_i           (prs2sagu_psh),                  //reset return stack
      .prs2sagu_pul_i           (prs2sagu_pul),                  //reset return stack
      .prs2sagu_set_i           (prs2sagu_set),                  //reset return stack
      .prs2sagu_sp_next_i       (prs2sagu_sp_next),              //relative address
