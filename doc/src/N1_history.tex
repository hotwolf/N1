...
\begin{center}
  ...
  \begin{longtable}{|r|p{80ex}|}
    ...
    \makecell[l]{
      ...
      (see \tabref{opcodes:alu:operators} and \tabref{words:ans:list})
    } \\
    ...
    February 29, 2024 &
    \makecell[l]{
      Added \secref{opcodes:freg:tc}, \\
      \secref{extensions:int}, \\
      \secref{extensions:key}, and \\
    ...
    May 15, 2025 &
    \makecell[l]{
      Updated \secref{architecture:principles:naming}  \\
      Added \secref{architecture:interfaces:registers} \\   
      Updated \secref{opcodes:freg} mapping
    } \\

    June 6, 2025 &
    \makecell[l]{
      Added \secref{extensions:pc} \\   
    } \\

   \today &
    %June 15, 2025 &
    \makecell[l]{
      Updated \secref{opcodes:branch} \\
      Reintroduced \secref{opcodes:freg:tc} \\
      Redefined reset and exception behavior in
      \secref{reset:rst}, \\
      \secref{reset:excpt}, 
      \tabref{reset:tc} \\
      Updated \secref{extensions:int}
    } \\
