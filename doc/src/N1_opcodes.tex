  ...
  \makebox[\textwidth][c]{
    \scalebox{0.4375} {
      \begin{tikzpicture}
        ...
        %Return bit
        \draw [thick, fill=gray!15] (0.8,0.3) rectangle (2,40.2);
        \node [above] at (1.4,40.2) {
        ...
        \draw [thick] (21.5,39.5) -- (22.5,39.5) -- (22.5,28.5) -- (21.5,28.5);
        \node [right] at (23,33.5) {
        ...
        %Jump
        \begin{scope}[shift={(1,36.5)}]
          \node at (0,0) {\usebox{\instruction}};
          \node         at (0.5,0.5)     {\huge{\texttt{1}}};
          \draw [thick] (1,0) rectangle  (2,1);
          \node         at (1.5,0.5)     {\huge{\texttt{1}}};
          \node         at (9,0.45)      {\LARGE{14-bit absolute word address $<$ 0x3FFF}};
          \node [right] at (16.2,0.5) {
            \begin{minipage}[l]{14em}
              \large{
                Jump \\
        ...
        \begin{scope}[shift={(1,28.5)}]
          ...
          \node         at (1.5,0.5)     {\huge{\texttt{0}}};
          \node         at (2.5,0.5)     {\huge{\texttt{1}}};
          \node         at (9.5,0.45)    {\LARGE{13-bit relative word address $<$ 0x1FFF}};
          \node [right] at (16.2,0.5) {
            \begin{minipage}[l]{14em}
              \large{
                Conditional branch \\
        ...
        \draw [thick] (21.5,26.5) -- (22.5,26.5) -- (22.5,27.5) -- (21.5,27.5);
        \node [right] at (23,27) {
          \begin{minipage}[l]{12em}
            \Huge{
              Literals
        ...
        %ALU instructions
        \draw [thick] (21.5,25.5) -- (22.5,25.5) -- (22.5,18.5) -- (21.5,18.5);
        \node [right] at (23,21.5) {
          \begin{minipage}[l]{12em}
            \Huge{
              ALU \\
              Instructions
        ...
        %Stack instructions
        \draw [thick] (21.5,16.5) -- (22.5,16.5) -- (22.5,17.5) -- (21.5,17.5);
        \node [right] at (23,16.5) {
          \begin{minipage}[l]{12em}
            \Huge{
              Stack \\
              Instructions
        ...
        \draw [thick] (21.5,15.5) -- (22.5,15.5) -- (22.5,4.5) -- (21.5,4.5);
        \node [right] at (23,9.5) {
          \begin{minipage}[l]{12em}
            \Huge{
              Memory \\
        ...
        \begin{scope}[shift={(1,10.5)}]
          ...
          \node         at (6.5,0.5)     {\huge{\texttt{1}}};
          \node         at (7.5,0.5)     {\huge{\texttt{1}}};
          \node         at (12,0.45)    {\LARGE{8-bit word address $<$ 0xFE}};
          \node [right] at (16.2,0.5) {
           \begin{minipage}[l]{14em}
              \large{
                Word read \\
        ...
        \draw [thick] (21.5,3.5) -- (22.5,3.5) -- (22.5,2.5) -- (21.5,2.5);
        \node [right] at (23,2.5) {
          \begin{minipage}[l]{12em}
            \Huge{
              Control \\
...
($uimm$) or a sign extended value( $simm$). \tabref{opcodes:alu:operators} lists the supported \gls{alu} operations.
  ...
  \begin{longtable}{|c|c|c|c|}
   ...
   %AND                               
    ...
    %Interrupt requests
      ...
      \multicolumn{2}{c|}{vector address} \\ \hline
...
The encoding of these instructions is shown in \tabref{opcodes:ctrl:instr}. Multiple control
