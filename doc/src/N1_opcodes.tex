    ...
    \scalebox{0.515} {
      \begin{tikzpicture}
        ...
        \begin{scope}[shift={(1,2.5)}]
          ...
          \node         at (7.5,0.5)     {\huge{\texttt{1}}};
          \node         at (12,0.45)     {\LARGE{register address}};
          \node [right] at (16.2,0.5) {
           \begin{minipage}[l]{14em}
              \large{
                Register read \\
...
(see \secref{opcodes:ctrl:iaoffs}).
...
%Interrupt and Exception Enables
...
\texttt{IEN} (interrupt enable) and \texttt{EEN} (exception enable) (see \figref{opcodes:ctrl:irq:fig}).
...
Each one of these bits is protected by a mask bit to atomic bit manipulations (see \tabref{opcodes:ctrl:irq:tab}).
  ...
  \makebox[\textwidth][c]{
    ...
    \scalebox{0.515} {
      \begin{tikzpicture}
        ...
        \draw [thick, fill=gray!3] (26,1) rectangle (28,2);  % 2
        \node at (27,1.5) {\Large{\texttt{EEN}}};
        \node at (29,1.5) {\huge{\texttt{0}}};               % 1
        \draw [thick, fill=gray!3] (30,1) rectangle (32,2);  % 0
        \node at (31,1.5) {\Large{\texttt{IEN}}};
        %Write
        ...
        \node at (25,0.5) {\Large{\texttt{EENMSK}}};
        \draw [thick, fill=gray!3] (26,0) rectangle (28,1);  % 2
        \node at (27,0.5) {\Large{\texttt{EEN}}};
        \draw [thick, fill=gray!3] (28,0) rectangle (30,1);  % 1
        \node at (29,0.5) {\Large{\texttt{IENMSK}}};
        \draw [thick, fill=gray!3] (30,0) rectangle (32,1);  % 0
        \node at (31,0.5) {\Large{\texttt{IEN}}};
        \end{tikzpicture}
    }
  }
  \caption{Interrupt and Exception Enable Register}
  \label{opcodes:ctrl:irq:fig}
  %\end{center}
\end{figure}
...
\begin{center}
  ...
  \begin{longtable}{|c|c|c|c|}
    \rowcolor{white}
    \caption{Interrupt and Exception Enable Register Bit Description}
    \label{opcodes:ctrl:irq:tab} \\
    %Header
    \hline                                     
    \rowcolor{gray!25}
    ...
    \multicolumn{1}{m{36em}|}{
      \makecell[l]{
        \begin{minipage}[t]{\linewidth}%  
          \centerline{\textbf{Exception Enable Mask}}
          \begin{description}[style=nextline]
          \item[Read:]
            Always reads zero.
          \item[Write:]
            Writing a \texttt{1} allows modification of the \texttt{EEN} bit in the same access.
          \end{description}
        \end{minipage}%
    }}  \\ \hline
   ...
   \makecell[l]{ 
     \begin{minipage}[t]{\linewidth}%  
     \centerline{\textbf{Exception Enable Bit}}
     \begin{description}[style=nextline]
     \item[Read:]
     \begin{minipage}[t]{\linewidth}  
     ...
     \begin{minipage}[t]{\linewidth}
       \begin{description}[style=multiline]
         \item[\texttt{0}:]
            Disable exceptions. Only possible while instantly writing a \texttt{1} to \texttt{EENMSK}. 
         \item[\texttt{1}:]
           Disable exceptions. Only possible while instantly writing a \texttt{1} to \texttt{EENMSK}.
       \end{description}
     \end{minipage}  
    ...
    \multicolumn{1}{m{36em}|}{
      \makecell[l]{
        \begin{minipage}[t]{\linewidth}%  
          \centerline{\textbf{Interrupt Enable Mask}}
          \begin{description}[style=nextline]
          \item[Read:]
            Always reads zero.
          \item[Write:]
            Writing a \texttt{1} allows modification of the \texttt{IEN} bit in the same access.
          \end{description}
        \end{minipage}%
    }}  \\ \hline
...
The current depth of the \gls{ps} is captured in the parameter stack depth register (see \figref{opcodes:ctrl:psd:fig}).
Writing \texttt{0x0000} to this register will clear the \gls{ps} (see \tabref{opcodes:ctrl:psd:fig}).
  ...
  \makebox[\textwidth][c]{
    ...
    \scalebox{0.515} {
      \begin{tikzpicture}
        ...
        \node at (15,1.5) {\huge{\texttt{PSP}}};
        %Write
        \node [align=right, anchor=east] at (0,0.5) {\large{Write}};
        %\draw [thick, fill=white]  (0,0) rectangle (32,1);
        \draw [thick, fill=gray!3]  (0,0) rectangle  (32,1); %15..0
        \node at (15,0.5) {\huge{\texttt{PSPCLR}}};
      \end{tikzpicture}
    }
  }
  \caption{Parameter Stack Depth Register}
  \label{opcodes:ctrl:psd:fig}
  %\end{center}
\end{figure}
...
\begin{center}
  ...
  \begin{longtable}{|c|c|c|c|}
    \rowcolor{white}
    \caption{Parameter Stack Depth Register Description}
    \label{opcodes:ctrl:psd:tab} \\
    %Header
    \hline                                     
    \rowcolor{gray!25}
    \multicolumn{1}{|c|}{\textbf{\rule{0pt}{2.5ex}Bit}}  &  
    ...
    \multicolumn{1}{m{36em}|}{
      \makecell[l]{
        \begin{minipage}[t]{\linewidth}%  
          ...
          \begin{description}[style=nextline]
          \item[Read:]
            Current parameter stack depth.
          \item[Write:]
            Writing the value \texttt{0x0000} will clrear the \gls{ps}.
            All other write accesses have no effect.
          \end{description}
        \end{minipage}%
    }}  \\ \hline
...
%Return Stack Depth
\subsubsection{Return Stack Depth}
\label{opcodes:ctrl:rsd}

The current depth of the \gls{rs} is captured in the parameter stack depth register (see \figref{opcodes:ctrl:rsd:fig}).
Writing \texttt{0x0000} to this register will clear the \gls{rs} (see \tabref{opcodes:ctrl:rsd:fig}).
...
\begin{center}
  ...
  \begin{longtable}{|c|c|c|c|}
    \rowcolor{white}
    \caption{Return Stack Depth Register Description}
    \label{opcodes:ctrl:rsd:tab} \\
    %Header
    \hline                                     
    \rowcolor{gray!25}
    \multicolumn{1}{|c|}{\textbf{\rule{0pt}{2.5ex}Bit}}  &  
...
\subsubsection{Immediate Address Offset}
\label{opcodes:ctrl:iaoffs}

Immediate address offset register (see \figref{opcodes:ctrl:iaoffs:fig}) provides an address offset
fore the immediate address mode. The effectife address is the sum of immediate address and immediate address offset (see \tabref{opcodes:ctrl:iaoffs:tab}).
  ...
  \makebox[\textwidth][c]{
    ...
    \scalebox{0.515} {
      \begin{tikzpicture}
        ...
        \node [align=right, anchor=east] at (0,1.5) {\large{Read}};
        \draw [thick, fill=white]   (0,1) rectangle (32,2);
        \draw [thick, fill=gray!3]  (0,1) rectangle (16,2); %15..8
        \node at  (8,1.5) {\huge{\texttt{IAOFFS}}};
        \node at (17,1.5) {\huge{\texttt{0}}};               % 7
        \node at (19,1.5) {\huge{\texttt{0}}};               % 6
        \node at (21,1.5) {\huge{\texttt{0}}};               % 5
        \node at (23,1.5) {\huge{\texttt{0}}};               % 4
        \node at (25,1.5) {\huge{\texttt{0}}};               % 3
        \node at (27,1.5) {\huge{\texttt{0}}};               % 2
        \node at (29,1.5) {\huge{\texttt{0}}};               % 1
        \node at (31,1.5) {\huge{\texttt{0}}};               % 0
        %Write
        \node [align=right, anchor=east] at (0,0.5) {\large{Write}};
        \draw [thick, fill=white]   (0,0) rectangle (32,1);
        \draw [thick, fill=gray!3]  (0,0) rectangle (16,1); %15..8
        \node at  (8,0.5) {\huge{\texttt{IAOFFS}}};
        \node at (17,0.5) {\huge{\texttt{0}}};               % 7
        \node at (19,0.5) {\huge{\texttt{0}}};               % 6
        \node at (21,0.5) {\huge{\texttt{0}}};               % 5
        \node at (23,0.5) {\huge{\texttt{0}}};               % 4
        \node at (25,0.5) {\huge{\texttt{0}}};               % 3
        \node at (27,0.5) {\huge{\texttt{0}}};               % 2
        \node at (29,0.5) {\huge{\texttt{0}}};               % 1
        \node at (31,0.5) {\huge{\texttt{0}}};               % 0
      \end{tikzpicture}
    }
  }
  \caption{Immediate Address Offset Register}
  \label{opcodes:ctrl:iaoffs:fig}
  %\end{center}
\end{figure}
...
\begin{center}
  ...
  \begin{longtable}{|c|c|c|c|}
    ...
    \multicolumn{1}{m{36em}|}{
      \makecell[l]{
        \begin{minipage}[t]{\linewidth}%  
          \centerline{\textbf{Immidiate Address Offset}}
          \begin{description}[style=nextline]
          \item[Read:]
            Upper byte of the immediate address offset.
          \item[Write:]
            Upper byte of the immediate address offset.
          \end{description}
        \end{minipage}%
...
%label{opcodes:ctrl:gpr}
%
%subsubsection{Internal Communication Registers}
%label{opcodes:ctrl:intcom}
%
%subsubsection{Interrupt Triggers}
%label{opcodes:ctrl:gpr}
%
%subsubsection{External Communication Register}
%label{opcodes:ctrl:extcom}
%
%subsubsection{Unimplemented Register Space}
%label{opcodes:ctrl:unimpl}
%
%begin{figure}[!htb]
% %\begin{center}
% \makebox[\textwidth][c]{
...
%       %Offset
%       \node [align=left, anchor=west] at (-2,3) {
%         \huge{Any unimplementes register location}
%       };        
%       %Index
%       \node [above] at  (1,2) {15};
%       \node [above] at  (3,2) {14};
...
%       %Write
%       \node [align=right, anchor=east] at (0,0.5) {\large{Write}};
%       \draw [thick, fill=white] (0,0) rectangle (32,1);    %15..0
%       \end{tikzpicture}
%   }
% }
% \caption{Interrupt and Exception Enable Register}
% \label{opcodes:ctrl:unimpl:fig}
% %\end{center}
%end{figure}
