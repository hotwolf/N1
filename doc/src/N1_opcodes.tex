...
\begin{center}
  ...
  \begin{longtable}{|c|c|c|}
    ...
    %Interrupt Mask Register (IEN)
    \texttt{0x03}                       &
    \hyperref[extensions:int]{IEN}      &
    \hyperref[extensions:int]{\textbf{Optional} Interrupt Enable Register} \\ \hline
...
%%Throw Code Register (TCR)
%\subsubsection{Throw Code Register (TCR)}
%\label{opcodes:freg:tcr}
%
%\begin{figure}[H]
%  %\begin{center}
%  \makebox[\textwidth][c]{
...
%\end{figure}
%
%The throw code register captures the \gls{tc} of the last exception (see \tabref{reset:tc}).
%Writing to this register triggers an exception.
%The optional \gls{catchext} (see  \secref{extensions:catch}) add further functionality to this register.
%
%\begingroup
%\setlength{\LTleft}{-20cm plus -1fill}
%\setlength{\LTright}{\LTleft}
