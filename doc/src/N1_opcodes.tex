...
\begin{center}
  ...
  \begin{longtable}{|c|c|c|}
    ...
    %EKEY? Register (EKEY?)
    \texttt{0x04}                                             &
    \hyperref[extensions:ke]{EKEY?}                           &
    \hyperref[extensions:ke]{\textbf{Optional} EKEY? Register} \\ \hline

    %EMIT? Register (EMIT?)
    \texttt{0x05}                                                  &
    \hyperref[extensions:ke]{EMIT?}                                &
    \hyperref[extensions:ke]{\textbf{Optional} EKEY/EMIT Register} \\ \hline
