  ...
  \begin{longtable}{|c|c|l|c|}
    ...
    %0>                                        
     ...
     %2/                                        
      ...
      \multicolumn{1}{m{50ex}|}{
        \makecell[l]{                   
          Shift x1 one bit towards the \gls{lsb}, while the \gls{msb} \\
          remains unchanged}}                                  &
      \multicolumn{1}{m{9ex}|}{
        \makecell[c]{                   
          \texttt{0x0F41}}}                                       \\ \hline
     ...
     %2@                                        
      ...
      \multicolumn{1}{m{50ex}|}{
        \makecell[l]{                   
          Fetch x2 from addr and x1 at addr+1}}                   &
      \multicolumn{1}{m{9ex}|}{
        \makecell[c]{                   
          \texttt{0x0750}                                         \\        %DUP 
          \texttt{0x0C01}                                         \\        %1+ 
     ...
     %2>R                                        
      ...
      \multicolumn{1}{m{50ex}|}{
        \makecell[l]{                   
          Shift cell pair x1 x2 to the \gls{rs}}}                 &
      \multicolumn{1}{m{9ex}|}{
        \makecell[c]{                   
          \texttt{0x06AB}                                         \\        %>R
     ...
     %2R>                                        
      ...
      \multicolumn{1}{m{50ex}|}{
        \makecell[l]{                   
          Shift cell pair x1 x2 to the \gls{ps}}}                 &
      \multicolumn{1}{m{9ex}|}{
        \makecell[c]{                   
          \texttt{0x0755}                                         \\        %R>
      ...
      \multicolumn{1}{m{50ex}|}{
        \makecell[l]{                   
          Copy cell pair x1 x2 to the \gls{ps}}}                  &
      \multicolumn{1}{m{9ex}|}{
        \makecell[c]{                   
          \texttt{0x0755}                                         \\        %R>
   ...
   %<>                                        
    ...
    %DEPTH
      ...
      \multicolumn{1}{m{50ex}|}{
        \makecell[l]{                   
          +n is the number of cells on the \gls{ps}               \\
          without +n}}  &
      \multicolumn{1}{m{9ex}|}{
        \makecell[c]{                   
          \texttt{0x00FF}}}                                       \\ \hline
    ...
    %I                                        
      ...
      \multicolumn{1}{m{50ex}|}{
        \makecell[l]{                   
          Copy the innermost loop index (n$\mid$u) onto the       \\
          \gls{ps}}}                                              &
      \multicolumn{1}{m{9ex}|}{
        \makecell[c]{                   
          \texttt{0x0754}}}                                       \\ \hline
    ...
    %J                                        
      ...
      \multicolumn{1}{m{50ex}|}{
        \makecell[l]{                   
          Copy the next-outer loop index (n$\mid$u) onto the      \\
          \gls{ps}}}                                              &
      \multicolumn{1}{m{9ex}|}{
        \makecell[c]{                   
          \texttt{0x0755}                                         \\
