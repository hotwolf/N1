...
\begin{center}
  ...
  \begin{longtable}{|c|c|c|}
    ...
    \texttt{0x02}                                                        &
    \hyperref[extensions:int]{IM}                                        &
    \hyperref[extensions:int]{\textbf{Optional} Interrupt Mask Register} \\ \hline

    %KEY/EMIT Register (KER)
    \texttt{0x04}                                                 &
    \hyperref[extensions:ke]{KER}                                 &
    \hyperref[extensions:ke]{\textbf{Optional} KEY/EMIT Register} \\ \hline
