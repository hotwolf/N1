...
single CPU instruction. \tabref{opcodes:ctrl:smpl} shows the set of simple control instructions
and thir encoding.
...
\begin{center}
  ...
  \begin{longtable}{|c|l|}
    \rowcolor{white}
    \caption{Nonconcurrent control instruction encoding}
    ...
    \multicolumn{1}{m{15em}|}{
    \makecell[l]{ 
      Capture program couter (PC+1) \\
      ( -- pc+1 )}}                 \\ \hline

    %Refetch opcode
    \texttt{0x0000000000000010}          &    
    \multicolumn{1}{m{15em}|}{
    \makecell[l]{ 
      Single cycle NOP \\
      ( -- )}}         \\ \hline
    ...
    \multicolumn{1}{m{15em}|}{
    \makecell[l]{ 
      Capture program couter (PC+2) \\
      ( -- pc+2 )}}                 \\ \hline

    %Fetch data bus
    \texttt{0x0000000000000100}          &    
    \multicolumn{1}{m{15em}|}{
    \makecell[l]{ 
      Capture next opcode \\
      ( -- opcode )}}     \\ \hline
