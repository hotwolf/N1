...
If available, hardware, external to the processor, is able to trigger exceptions as described in \secref{reset:excpt}.
...
The Program Counter Register (PC) (see \figref{extensions:pc:fig}) always reads the PC of the current instruction.
  ...
  \makebox[\textwidth][c]{
    ...
    \scalebox{0.515} {
      \begin{tikzpicture}
        ...
        %\node at (29,0.5) {\Large{\texttt{IMWE}}};
        \draw [thick, fill=gray!3] (0,0) rectangle (32,2);  % 0
        \node at (16,1)   {\Large{\texttt{PC}}};
        \end{tikzpicture}
    }
  }
  \caption{Program Counter Register}
  \label{extensions:pc:fig}
  \end{center}
\end{figure}
