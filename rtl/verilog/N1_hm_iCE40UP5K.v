  ...
  #(parameter   SP_WIDTH   =  8,                                  //width of a stack pointer
   ...
   SB_MAC16_pagu
     (.CLK                       (clk_i),                         //clock input
      ...
      .OLOADBOT                  (fc_hm_abs_rel_b_i),             //absolute COF
      .ADDSUBTOP                 (alu_hm_sub_add_b_i),            //subtract
      .ADDSUBBOT                 (1'b0),                          //always use adder
      .OHOLDTOP                  (1'b1),                          //keep hold register stable
      .OHOLDBOT                  (~fc_hm_update_i),               //update PC
      .CI                        (1'b0),                          //no carry
   ...
   SB_MAC16_sagu
     (.CLK                       (clk_i),                         //clock input
      ...
      .ORSTBOT                   (|{async_rst_i,sync_rst_i}),     //use common reset
      .OLOADTOP                  (ips_hm_rst_i),                  //soft reset
      .OLOADBOT                  (irs_hm_rst_i),                  //soft reset
      .ADDSUBTOP                 (ips_hm_psh_i),                  //push (decrement address)
      .ADDSUBBOT                 (irs_hm_pul_i),                  //pull (decrement address)
      .OHOLDTOP                  (~|{ips_hm_psh_i,                //update PSP
                                     ips_hm_pul_i,                //
                                     ips_hm_rst_i}),              //
      .OHOLDBOT                  (~|{irs_hm_psh_i,                //update RSP
                                     ips_hm_pul_i,                //
                                     ips_hm_rst_i}),              //
      .CI                        (1'b0),                          //no carry
      .ACCUMCI                   (1'b0),                          //no carry
   ...
   assign ips_hm_sp_o = sagu_out[SP_WIDTH+15:16];
   assign irs_hm_sp_o = sagu_out[SP_WIDTH-1:0];
   ...
   //Output
   assign alu_hm_mul_res_o = {(alu_hm_smul_umul_b_i ? alu_smul_out[31:16] : alu_umul_out[31:16]),
                                                                            alu_umul_out[15:0]};
